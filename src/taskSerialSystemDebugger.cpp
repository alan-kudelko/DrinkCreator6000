...
void ram_dump(){
  ...
  uart_puts_P_blocking(msg_ramDump_data_header); uart_puts_blocking(buffer);
  ...
  uart_puts_P_blocking(msg_ramDump_seperator); uart_puts_blocking(buffer); uart_puts_P_blocking(msg_ramDump_data_footer);
